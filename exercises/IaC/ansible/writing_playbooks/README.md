...
### Writing a playbook
Let's create our first playbook using the the YAML we looked at earlier. Write the following YAML in to `/vols/ansible_9295/writing_playbooks/ansible/webserver.yml`
...
Now execute playbook with the following command: `ansible-playbook /vols/ansible_9295/writing_playbooks/ansible/webserver.yml`
...
rootdir: /vols/pytest_26426, inifile: pytest.ini
...
Revision: 7e871e02fa7035aa707ba83af9244e0c