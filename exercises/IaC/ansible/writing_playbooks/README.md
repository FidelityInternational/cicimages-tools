...
### Writing a playbook
Let's create our first playbook using the the YAML we looked at earlier. Write the following YAML in to `/vols/ansible_28613/writing_playbooks/ansible/webserver.yml`
...
Now execute playbook with the following command: `ansible-playbook /vols/ansible_28613/writing_playbooks/ansible/webserver.yml`
...
rootdir: /vols/pytest_26999, inifile: pytest.ini
...
Revision: 2584d75109f1cdaf357ed2b0ce112faf